...
const Mobile3: FunctionComponent = () => {
  return (
    <div className="relative bg-base-white w-full overflow-hidden flex flex-col items-start justify-start text-left text-5xl text-black font-text-sm-medium sm:w-[375px] sm:gap-[0px]">
      ...
      <div className="my-0 mx-[!important] absolute right-[1px] bottom-[0.04px] rounded-t-9xl rounded-b-none bg-base-white shadow-[0px_20px_24px_-4px_rgba(16,_24,_40,_0.08),_0px_8px_8px_-4px_rgba(16,_24,_40,_0.03)] w-[374px] overflow-hidden flex flex-col items-center justify-center z-[3] text-lg text-gray-900 font-work-sans sm:self-stretch sm:w-auto sm:box-content sm:overflow-y-hidden sm:overscroll-y-none">
        <div className="self-stretch bg-base-white flex flex-col items-center justify-start">
          <div className="self-stretch bg-base-white flex flex-col pt-6 px-6 pb-0 items-start justify-start gap-[16px]">
            ...
            <div className="self-stretch flex flex-row items-center justify-between text-base text-gray-500 font-text-sm-medium">
